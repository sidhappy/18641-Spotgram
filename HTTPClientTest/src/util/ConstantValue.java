package util;
/**
 * ConstantValue.java 	Version <1.00>	ÏÂÎç2:34:09
 *
...
public class ConstantValue {
	...
	public static final String KEY_RADIUS_KM = "radius_km";
	public static final String KEY_MAX_NOTE = "max_note";
	public static final String KEY_START_NOTE = "start_note";
	public static final String KEY_NOTR = "note";
	public static final String KEY_USER_ID = "user_id";
	public static final String KEY_NOTE_ID = "note_id";
	public static final String KEY_COMMENT_ID = "comment_id";
	public static final String KEY_INFO = "info";
	public static final String KEY_CONTENT = "content";
	public static final String KEY_NOTE_LIST = "note_lists";
	...
	public static final String JSON_LOC_LONGITUDE = "loc_longitude";
	public static final String JSON_LOC_LATITUDE = "loc_latitude";
