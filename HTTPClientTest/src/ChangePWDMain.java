 ...
 */
public class ChangePWDMain {
	public static final String URL = "http://localhost/SpotagramServer/ChangePwdServlet";
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_USER_ID, "1"));
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_PWD, "jack"));
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_NEW_PWD, "jackjack"));
