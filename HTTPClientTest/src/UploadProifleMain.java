 ...
 */
public class UploadProifleMain {
	public static final String URL = "http://localhost/SpotagramServer/UploadProfileServlet";
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            builder.addPart(ConstantValue.KEY_USER_ID, new StringBody(4+"", ContentType.TEXT_PLAIN));
