...
public class GetLocationNoteMain {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_RADIUS_KM, "80000"));
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_MAX_NOTE, "100"));
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_START_NOTE, "0"));
