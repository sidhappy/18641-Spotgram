 ...
 */
public class GetUserNoteMain {
	public static final String URL = "http://localhost/SpotagramServer/GetUserNotesServlet";
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            nvps.add(new BasicNameValuePair(ConstantValue.KEY_USER_ID, "4"));
